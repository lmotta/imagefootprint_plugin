...
<qgis version="2.14.5-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="meta_html">
      <widgetv2config IsMultiline="1" fieldEditable="0" UseHtml="1" labelOnTop="1"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="singleSymbol" enableorderby="0">
    <symbols>
      <symbol alpha="0.419608" clip_to_extent="1" type="fill" name="0">
  ...
  <attributeactions>
    <actionsetting action="from qgis import ( gui as QgsGui, utils as QgsUtils )&#xa;from imagefootprint_plugin import CatalogFootprint&#xa;&#xa;nameAction = &quot;zoom&quot;&#xa;&#xa;sourceRaster = &quot;[% replace(  &quot;filename&quot; , '\\', '/')%]&quot;&#xa;vreturn = CatalogFootprint.actionCatalog( nameAction, sourceRaster )&#xa;if not vreturn['isOk']:&#xa;  msgBar =  QgsUtils.iface.messageBar()&#xa;  msgBar.pushMessage(  &quot;Action %s&quot; % nameAction,  vreturn['msg'], QgsGui.QgsMessageBar.WARNING, 4 )&#xa; " icon="" capture="0" type="1" name="Zoom Image"/>
    <actionsetting action="from qgis import ( gui as QgsGui, utils as QgsUtils )&#xa;from imagefootprint_plugin import CatalogFootprint&#xa;&#xa;nameAction = &quot;highlight&quot;&#xa;&#xa;sourceRaster = &quot;[% replace(  &quot;filename&quot; , '\\', '/')%]&quot;&#xa;vreturn = CatalogFootprint.actionCatalog( nameAction, sourceRaster )&#xa;if not vreturn['isOk']:&#xa;  msgBar =  QgsUtils.iface.messageBar()&#xa;  msgBar.pushMessage(  &quot;Action %s&quot; % nameAction,  vreturn['msg'], QgsGui.QgsMessageBar.WARNING, 4 )&#xa; " icon="" capture="0" type="1" name="Highlight Image"/>
    <actionsetting action="from qgis import ( gui as QgsGui, utils as QgsUtils )&#xa;from imagefootprint_plugin import CatalogFootprint&#xa;&#xa;nameAction = &quot;show_hideImage&quot;&#xa;&#xa;sourceRaster = &quot;[% replace(  &quot;filename&quot; , '\\', '/')%]&quot;&#xa;vreturn = CatalogFootprint.actionCatalog( nameAction, sourceRaster )&#xa;if not vreturn['isOk']:&#xa;  msgBar =  QgsUtils.iface.messageBar()&#xa;  msgBar.pushMessage(  &quot;Action %s&quot; % nameAction,  vreturn['msg'], QgsGui.QgsMessageBar.WARNING, 4 )&#xa; " icon="" capture="0" type="1" name="Show/Hide Image"/>
    <actionsetting action="from qgis import ( gui as QgsGui, utils as QgsUtils )&#xa;from imagefootprint_plugin import CatalogFootprint&#xa;&#xa;nameAction = &quot;setCurrent&quot;&#xa;&#xa;sourceRaster = &quot;[% replace(  &quot;filename&quot; , '\\', '/')%]&quot;&#xa;vreturn = CatalogFootprint.actionCatalog( nameAction, sourceRaster )&#xa;if not vreturn['isOk']:&#xa;  msgBar =  QgsUtils.iface.messageBar()&#xa;  msgBar.pushMessage(  &quot;Action %s&quot; % nameAction,  vreturn['msg'], QgsGui.QgsMessageBar.WARNING, 4 )&#xa; " icon="" capture="0" type="1" name="Set Current Image"/>
  </attributeactions>
  <editform></editform>
  <editforminit/>
